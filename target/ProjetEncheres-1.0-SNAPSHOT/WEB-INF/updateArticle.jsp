...
<div class="container">
    <form method="POST" action="updateArticle">
        ...
        <div class="containerAddressDefault">
            ...
            <input type="hidden" id="idAddress" name="idAddress"  value="${a.withdrawal.id}">
            <input type="hidden" id="idArticle" name="idArticle"  value="${a.id}">

        </div>
        <input style="margin-top: 20px" type="submit" value="Modifier mon article" class="btn btn-primary">
    </form>
</div>
</body>
</html>
